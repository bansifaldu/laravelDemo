    ...
    <form action="{{ $register_url }}" method="post">
        ...
        <div class="col-12 col-sm-12">
            <div class="form-group">
              <label>Role</label>
              <div class="">
                <select class="selectpicker1 col-sm-12" id="role_id" multiple data-live-search="true" name="role_id[]">
        ...
        {{-- <div class="input-group mb-3">
             ...
             <input type="text" name="role_id" class="form-control {{ $errors->has('role_id') ? 'is-invalid' : '' }}"
                   value="{{ old('role_id') }}" placeholder="{{ __('Role') }}" autofocus>  
             <div class="input-group-append">
                <div class="input-group-text">
                    <span class="fas fa-user {{ config('adminlte.classes_auth_icon', '') }}"></span>
                </div>
